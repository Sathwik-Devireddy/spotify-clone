...
const DisplayAlbum = () => {
  ...
  if (!album) {
    return <p className="text-center text-white mt-10">Album not found</p>;
  }
  ...
  return (
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end text-white">
        <img className="w-48 rounded" alt={album.name} src={album.image} />
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            <img
              ...
              alt="Spotify logo"
            />
            <b>Spotify</b> · 23,45,668 likes · <b>50 songs</b>, about 2hr 30 min
          </p>
        </div>
      </div>
